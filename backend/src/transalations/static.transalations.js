      ...
      footer: {
        ...
        services: {
          ...
          list: [
            ...
            "IA + surveillance à distance basée sur l'IoT",
            "Audit et évaluation",
      ...
      footer: {
        ...
        services: {
          ...
          list: [
            ...
            "IA + monitoramento remoto baseado em IoT",
      ...
      footer: {
        ...
        services: {
          ...
          list: [
            ...
            "IA + monitoreo remoto basado en IoT",
      ...
      footer: {
        ...
        services: {
          ...
          list: [
            ...
            "ИИ + удаленный мониторинг на базе IoT",
            "Аудит и оценка",
        ...
        industries: {
          title: "Отрасли",
          list: [
            "Горное дело и интеллектуальные ресурсы",
            "Нефть и Газ",
      ...
      pages: {
        services: {
          hero: {
            ...
            subtitle: "全球信赖",
            description:
              "通过全面的测试、检验、认证和咨询服务确保各行业的安全、保障和可持续性。",
            primaryCTAText: "探索服务",
        ...
        careers: {
          title: "当前职位空缺",
          description:
            "探索我们全球组织中激动人心的职业发展机会。找到理想的职位，助您职业发展。",
          applyNow: "立即申请",
          hiringProcess: {
            title: "我们的招聘流程",
            description:
              "我们设计的流程透明、高效，并专注于寻找合适的相互契合点。",
            steps: {
              review: {
                title: "申请审核",
                description:
                  "我们的人才团队将根据职位要求审核您的申请和资格。",
              },
              interview: {
                title: "初次面试",
                description:
                  "通过电话或视频面试来讨论您的背景、兴趣以及是否适合该职位。",
              },
              assessment: {
                title: "技术评估",
                description:
                  "特定角色的技术评估或案例研究来评估您的能力。",
              },
              final: {
                title: "最终面试",
                description:
                  "与招聘经理和团队成员会面，讨论合作和后续步骤。",
              },
            },
          },
          currentOpenings: {
        ...
        contact: {
          ...
          officesDescription:
            "我们在全球各地设有办事处，随时为您提供服务。查找您附近的 CBM 办事处，获取本地支持和服务。",
          formTitle: "给我们留言",
          formDescription:
            "填写下面的表格，我们的专家将在 24 小时内回复您。",
          supportTitle: "获得直接支持",
          supportDescription:
            "想直接联系？我们的客户支持团队随时准备解答您的紧急问题和请求。",
          ...
          labels: {
            ...
            message: "信息 *",
            consent:
              "我同意 CBM 处理我的个人数据以回复我的咨询。我理解我可以随时撤回同意。",
          },
          placeholders: {
            firstName: "约翰",
            lastName: "多伊",
      ...
      services: {
        ...
        servicesList: [
          ...
          },
          {
            ...
            title: "创新与研发",
            description:
              "由物联网、人工智能、机器人和工业 4.0 技术支持的下一代解决方案。",
            icon: "Brain",
            link: "/services/innovation-rd",
            features: [
              "物联网和人工智能监控",
