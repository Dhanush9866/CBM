        ...
        <div className="py-16 lg:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              {/* Social QR Codes Container */}
              <div className="pt-4 mt-4 border-t border-tuv-gray-800 flex gap-4">
                {/* Telegram QR */}
                <div className="relative group inline-block">
                  <a href="#" className="flex flex-col items-center cursor-pointer">
                    ...
                    />
                    <span className="text-xs text-tuv-gray-400 mt-1 group-hover:text-white transition-colors">Telegram</span>
                  </a>
                ...
                <div className="relative group inline-block">
                  <a href="https://wa.me/447934980214" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center cursor-pointer">
                    <img
                      ...
                      className="w-8 h-8 object-contain bg-white rounded p-1"
                    />
                    <span className="text-xs text-tuv-gray-400 mt-1 group-hover:text-white transition-colors">WhatsApp</span>
                  </a>
                ...
                <div className="relative group inline-block">
                  <a href="#" className="flex flex-col items-center cursor-pointer">
                    <img
                      ...
                      className="w-8 h-8 object-contain bg-white rounded p-1"
                    />
                    <span className="text-xs text-tuv-gray-400 mt-1 group-hover:text-white transition-colors">WeChat</span>
                  </a>
                ...
                {/* LinkedIn QR */}
                <div className="relative group inline-block">
                  <a href="https://www.linkedin.com/company/cbm-360%C2%B0-tiv%E2%84%A2/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center cursor-pointer">
                    <img
                      src="/assets/qr/linkedin.png"
                      alt="LinkedIn QR"
                      className="w-8 h-8 object-contain bg-white rounded p-1"
                    />
                    <span className="text-xs text-tuv-gray-400 mt-1 group-hover:text-white transition-colors">LinkedIn</span>
                  </a>
